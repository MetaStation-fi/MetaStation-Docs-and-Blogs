...
Get from zero to your first trade in under 5 minutes.
...
3. Pick a trading pair — e.g. `BTCUSDC`
4. Choose **Spot** or **Futures**
5. Set your order type, size, and optional Take Profit / Stop Loss
6. Click **Buy / Long** or **Sell / Short**

:::note
The MetaStation Account supports both spot and perpetual futures with gasless execution. No network gas fees on orders.
:::
...
| I want to… | Go to… |
|---|---|
| Connect Binance / ByBit / KuCoin | [Connect an Exchange](/docs/trading/connect-exchange) |
| Copy a successful trader | [Browse Marketplace](/docs/social-trading/browse-marketplace) |
| Automate TradingView alerts | [Webhook Trading](/docs/automation/webhook-trading) |
| Use Telegram signals | [Telegram-to-Trade](/docs/automation/telegram-to-trade) |
| Become a signal provider | [Become a Provider](/docs/social-trading/become-provider) |
