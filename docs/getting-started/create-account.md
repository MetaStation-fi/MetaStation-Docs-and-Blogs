...
5. You are logged in — your **MetaStation Account** is active immediately

No KYC is required to start trading on your MetaStation Account.

Already registered? Sign in at [metastation.fi/login](https://metastation.fi/login).
...
| Item | Details |
|---|---|
| MetaStation Account | Your default account — a **Web3 account**. Spot and perpetuals, gasless execution |
...
[Fund your account](/docs/getting-started/fund-account) for how the Funding Wallet works.
:::
...
→ [Fund your MetaStation Account](/docs/getting-started/fund-account) to start trading.
